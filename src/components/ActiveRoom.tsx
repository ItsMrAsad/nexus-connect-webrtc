...
import { Users, UserPlus, CheckCircle2, Link, PanelLeftClose, PanelLeftOpen, Copy, Check } from 'lucide-react';
...
export function ActiveRoom({ isHost }: { isHost: boolean }) {
  ...
  const copyInviteLink = () => {
    // Build a clean invite URL that goes to the home page with room pre-filled
